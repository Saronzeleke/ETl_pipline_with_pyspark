...
def transform_data(trips_df, weather_df, spark):
    """Clean, enrich, integrate weather, and aggregate trips"""
    ...
    # 2️⃣ Integrate weather
    integrated = transformer.integrate_datasets(enriched, weather_df)
...
def load_data(aggregated):
    ...
    try:
        ...
        for table_name, df in aggregated.items():
            ...
            df.write.mode("overwrite").parquet(str(export_path))
